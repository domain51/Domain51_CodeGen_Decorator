--TEST--
Domain51_CodeGen_Decorator_Method_Signature requires a ReflectionMethod object at instantiation
--FILE--
<?php
// BEGIN REMOVE
...
$reflection = new ReflectionClass('Domain51_CodeGen_Decorator_Method_Signature');
